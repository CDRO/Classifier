...
5. Verify the API, n8n scan behavior, document metadata inspection, PDF preparation, browser file serving, path traversal protection, configuration update, and mounted destinee-folder creation.
