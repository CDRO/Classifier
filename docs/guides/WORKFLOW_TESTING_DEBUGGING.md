...
5. Verify the API, n8n scan behavior, document metadata inspection, PDF preparation, browser file serving, lifecycle transitions, processing history, path traversal protection, destinee finalization, configuration update, and mounted destinee-folder creation.
